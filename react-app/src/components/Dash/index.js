...
const Dash = () => {
  ...
  let [pathArc, setPathArc] = useState(
    path.arc(-80, -414, 113, 0 * (Math.PI / 180), speed * 0.0485)
  );

  const [_, setCurrentLocation] = useState({});
    ...
    <>
      ...
      <div className="warning-container">
        <button
          ...
          hidden={engineHidden}
          onClick={() =>
            engineHidden ? setEngineHidden(true) : setEngineHidden(true)
          }
        >
          <Engine color="white" />
        </button>
        <button
          ...
          className="warnings"
          hidden={oilHidden}
          onClick={() => (oilHidden ? setOilHidden(false) : setOilHidden(true))}
        >
          <Oil color="white" />
        </button>
        <button
          ...
          className="warnings"
          hidden={gasHidden}
          onClick={() => (gasHidden ? setGasHidden(false) : setGasHidden(true))}
        >
          <Gas color="white" />
        </button>
        <button
          id="battery"
          className="warnings"
          hidden={batteryHidden}
          onClick={() =>
            batteryHidden ? setBatteryHidden(false) : setBatteryHidden(true)
          }
        >
          <Battery color="white" />
        </button>
        <button
          ...
          hidden={lightsHidden}
          onClick={() =>
            lightsHidden ? setLightsHidden(false) : setLightsHidden(true)
          }
        >
          <Lights color="white" />
        </button>
      ...
      {!toggle && (
        <div className="manual-controls-container">
          ...
          <ManualDropDownEmitters
            engineHidden={engineHidden}
            setEngineHidden={setEngineHidden}
            oilHidden={oilHidden}
            setOilHidden={setOilHidden}
            gasHidden={gasHidden}
            setGasHidden={setGasHidden}
            batteryHidden={batteryHidden}
            setBatteryHidden={setBatteryHidden}
            lightsHidden={lightsHidden}
            setLightsHidden={setLightsHidden}
          />
        </div>
      )}
    </>
