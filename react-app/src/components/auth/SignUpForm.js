  ...
  return (
    <>
      ...
      <form onSubmit={handleSubmit} className="signup-form">
        ...
        <label className="custom-file-upload" htmlFor="profile-pic">
          CLICK
          <span style={{ color: "rgb(5,122,152)" }}> HERE </span>TO UPLOAD A
          PROFILE PHOTO
          <input
        ...
        <div>
          <label htmlFor="gps-permission">
            Would you like to enable GPS location services?
          </label>
          <input
            id="gps-permission"
            type="checkbox"
            name="gpsPermission"
            onChange={(e) => {
              gpsPermission ? setGpsPermission(false) : setGpsPermission(true);
            }}
            value={gpsPermission}
          ></input>
        </div>
